...
public class VistasVendedor1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VistasVendedor
     */
    public VistasVendedor1() {
        initComponents();
    }
    ...
    private void btnCrearVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearVActionPerformed
        ...
        if (!textCodigo.getText().isEmpty() && !textNombre.getText().isEmpty() && !textCaja.getText().isEmpty() && !textVentas.getText().isEmpty()
                && !textGenero.getText().isEmpty() && !pwdField.getText().isEmpty()) {
            listaVendedores.add(new Vendedor(Integer.parseInt(textCodigo.getText()), textNombre.getText(), Integer.parseInt(textCaja.getText()), Integer.parseInt(textVentas.getText()), textGenero.getText(),pwdField.getText()));
            JOptionPane.showMessageDialog(null, "Felicidades has agregado un nuevo vendedor");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistasVendedor1().setVisible(true);
            }
        });
    }
