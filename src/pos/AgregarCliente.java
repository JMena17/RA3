...
public class AgregarCliente extends javax.swing.JFrame {
    ...
    private void btnCrearVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearVActionPerformed
        ...
        if (!textCodigo.getText().isEmpty() && !textNombre.getText().isEmpty() && !textNit.getText().isEmpty() && !textCorreo.getText().isEmpty() &&
            !textGenero.getText().isEmpty()) {
            Clientes.listasClientes.add(new Clientes(Integer.parseInt(textCodigo.getText()), textNombre.getText(), Integer.parseInt(textNit.getText()), textCorreo.getText(), textGenero.getText()));
            JOptionPane.showMessageDialog(null, "Felicidades has agregado una nuevo Cliente!");
