...
public class CrearProductos extends javax.swing.JFrame {
    ...
    private void btnCrearVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearVActionPerformed
        ...
        if (!textCodigo.getText().isEmpty() && !textNombre.getText().isEmpty() && !textDescripcion.getText().isEmpty() && !textCantidad.getText().isEmpty() &&
            !textPrecio.getText().isEmpty()) {
            Productos.listaProductos.add(new Productos(Integer.parseInt(textCodigo.getText()), textNombre.getText(), textDescripcion.getText(), Integer.parseInt(textCantidad.getText()), Integer.parseInt(textPrecio.getText()) ));
            JOptionPane.showMessageDialog(null, "Felicidades has agregado una nuevo Producto!");
