...
public class Agregar_Sucursal extends javax.swing.JFrame {
    ...
    private void btnCrearVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearVActionPerformed
        ...
        if (!textCodigo.getText().isEmpty() && !textDepart.getText().isEmpty() && !textDireccion.getText().isEmpty() && !textCorreo.getText().equals('@') && !textCorreo.getText().equals(".com")
            && !textTel.getText().isEmpty()) {
            Sucursales.listaSucursales.add(new Sucursales(Integer.parseInt(textCodigo.getText()), textDepart.getText(), textDireccion.getText(), textCorreo.getText(), Integer.parseInt(textTel.getText()) ));
