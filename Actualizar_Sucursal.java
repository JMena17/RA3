...
public class Actualizar_Sucursal extends javax.swing.JFrame {
    ...
    private void btnActualizarVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarVActionPerformed
       ...
       Sucursales sucursal = new Sucursales(Integer.parseInt(textCodigo.getText()), textDepart.getText(), textDireccion.getText(), textCorreo.getText(), Integer.parseInt(textTel.getText()));
       sucursalesRelacional nuevoS = new sucursalesRelacional();
       sucursalDAO.actualizar(codigo, sucursal);
       Tabla nuevo = new Tabla();
       dispose();
    ...
    public void mostrar(int codigo) {
        ...
        sucursalesDAO sucu = new sucursalesRelacional();
        Sucursales sucursalAct = sucu.obtener(codigo);
        
        textCodigo.setText(sucursalAct.getCodigo()+"");
        textDepart.setText(sucursalAct.getDepartamento());
        textDireccion.setText(sucursalAct.getDireccion());
        textCorreo.setText(sucursalAct.getCorreo());
        textTel.setText(sucursalAct.getTelefono()+"");
        
    }
    
    public static void main(String args[]) {

        Actualizar_Sucursal instancia = new Actualizar_Sucursal();
        instancia.mostrar(0);
